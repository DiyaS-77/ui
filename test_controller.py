...
class TestControllerUI(QWidget):
    ...
    def __init__(self,bluetooth_device_manager, back_callback):
        """
        ...
        self.bluez_logger = bluetooth_device_manager
        self.scroll = None
    ...
    def controller_ui(self):
        ...
        self.log_file_path=self.bluez_logger.start_dump_logs(interface=self.bluez_logger.interface)
