...
#------PROFILE SELECTION----------------
    ...
    def test_application_clicked(self):
        ...
        self.bluetooth_device_manager=BluetoothDeviceManager(self.interface,self.log_path)
        #self.bluez_logger=BluetoothDeviceManager(log_path=self.log_path)
        ...
        self.bluetoothd_log_file_path=self.bluetooth_device_manager.start_bluetoothd_logs()
        ...
        self.pulseaudio_log_file_path=self.bluetooth_device_manager.start_pulseaudio_logs()
        ...
        # Start HCI dump logs
        self.hci_log_file_path=self.bluetooth_device_manager.start_dump_logs(interface=self.interface)
